...
Sub LOAD_SALESMAN
	...
	Next
	CMB_SALESMAN.cmbBox.Add("NO SALESMAN")
End Sub
Sub LOAD_WAREHOUSE
...
Sub LOAD_REASON
	If CMB_WAREHOUSE.SelectedIndex = CMB_WAREHOUSE.cmbBox.IndexOf("BO WAREHOUSE") Then
		...
		CMB_REASON.cmbBox.Add("INFESTED")
	...
	Else
		...
		CMB_REASON.cmbBox.Add("CLOSE ACCOUNT")
		CMB_REASON.cmbBox.Add("NO RETURN")
	End If
End Sub
		...
		Else
			...
			Sleep(100)
				...
				End If
						...
						Sleep(0)
						ToastMessageShow("Product Return Added",  False)
...
'						OpenSpinner(CMB_UNIT.cmbBox)
						CLEAR_EXPIRATION
						Sleep(100)
						PANEL_BG_INPUT.SetVisibleAnimated(100, False)
						Sleep(0)
						LOAD_RETURN_PRODUCT
			Else
...
Sub LOG_RETURN_UPLOAD
	...
	connection.ExecNonQuery2(query,Array As String(return_id,DateTime.Date(DateTime.Now), DateTime.Time(DateTime.Now), LOGIN_MODULE.username, LOGIN_MODULE.tab_id))
End Sub
