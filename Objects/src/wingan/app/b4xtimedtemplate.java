...
public class b4xtimedtemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "wingan.app.b4xtimedtemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", wingan.app.b4xtimedtemplate.class).invoke(this, new Object[] {null});
        else
...
public wingan.app.anotherprogressbar _anotherprogressbar1 = null;
...
_anotherprogressbar1 = new wingan.app.anotherprogressbar();
...
public ResumableSub_Show(wingan.app.b4xtimedtemplate parent,wingan.app.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
wingan.app.b4xtimedtemplate parent;
