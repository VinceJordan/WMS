...
public class monthlyinv_module extends android.support.v7.app.AppCompatActivity implements B4AActivity{
	public static monthlyinv_module mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "wingan.app", "wingan.app.monthlyinv_module");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (monthlyinv_module).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "wingan.app", "wingan.app.monthlyinv_module");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "wingan.app.monthlyinv_module", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (monthlyinv_module) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (monthlyinv_module) Resume **");
...
@Override
 ...
 protected void onStop() {
    ...
    public static Class<?> getObject() {
		return monthlyinv_module.class;
	}
	...
	public void onPause() {
        ...
        if (!dontPause)
            BA.LogInfo("** Activity (monthlyinv_module) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        else
            BA.LogInfo("** Activity (monthlyinv_module) Pause event (activity is not paused). **");
        if (mostCurrent != null)
    ...
    private static class ResumeMessage implements Runnable {
		...
		public void run() {
            monthlyinv_module mc = mostCurrent;
...
public de.amberhome.objects.appcompat.ACToolbarDarkWrapper _actb_monthly_inv = null;
public anywheresoftware.b4a.objects.ScrollViewWrapper _sv_monthly_inv = null;
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 36;BA.debugLine="Activity.LoadLayout(\"monthly\")";
mostCurrent._activity.LoadLayout("monthly",mostCurrent.activityBA);
 //BA.debugLineNum = 40;BA.debugLine="ABHelper.Initialize";
mostCurrent._abhelper.Initialize(mostCurrent.activityBA);
 //BA.debugLineNum = 41;BA.debugLine="ABHelper.ShowUpIndicator = True";
mostCurrent._abhelper.setShowUpIndicator(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 42;BA.debugLine="End Sub";
return "";
}
public static String  _activity_createmenu(de.amberhome.objects.appcompat.ACMenuWrapper _menu) throws Exception{
 //BA.debugLineNum = 52;BA.debugLine="Sub Activity_CreateMenu(Menu As ACMenu)";
...
mostCurrent._abhelper = new de.amberhome.objects.appcompat.ACActionBar();
 //BA.debugLineNum = 19;BA.debugLine="Private ACTB_MONTHLY_INV As ACToolBarDark";
mostCurrent._actb_monthly_inv = new de.amberhome.objects.appcompat.ACToolbarDarkWrapper();
 //BA.debugLineNum = 20;BA.debugLine="Private SV_MONTHLY_INV As ScrollView";
mostCurrent._sv_monthly_inv = new anywheresoftware.b4a.objects.ScrollViewWrapper();
