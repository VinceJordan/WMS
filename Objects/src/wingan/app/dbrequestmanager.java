...
public class dbrequestmanager extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "wingan.app.dbrequestmanager");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", wingan.app.dbrequestmanager.class).invoke(this, new Object[] {null});
        else
...
public wingan.app.httpjob  _executebatch(anywheresoftware.b4a.objects.collections.List _listofcommands,Object _tag) throws Exception{
wingan.app.httpjob _j = null;
...
public void  _executebatchimpl(wingan.app.httpjob _job,anywheresoftware.b4a.objects.collections.List _listofcommands,Object _tag) throws Exception{
...
public ResumableSub_ExecuteBatchImpl(wingan.app.dbrequestmanager parent,wingan.app.httpjob _job,anywheresoftware.b4a.objects.collections.List _listofcommands,Object _tag) {
this.parent = parent;
this._job = _job;
this._listofcommands = _listofcommands;
this._tag = _tag;
}
wingan.app.dbrequestmanager parent;
wingan.app.httpjob _job;
...
parent.__c.LogImpl("781985541","Error building command: "+BA.ObjectToString(parent.__c.LastException(parent.getActivityBA())),0);
...
public wingan.app.httpjob  _executecommand(wingan.app.main._dbcommand _command,Object _tag) throws Exception{
...
if (true) return _executebatch(anywheresoftware.b4a.keywords.Common.ArrayToList(new wingan.app.main._dbcommand[]{_command}),_tag);
 //BA.debugLineNum = 64;BA.debugLine="End Sub";
return null;
}
public wingan.app.httpjob  _executequery(wingan.app.main._dbcommand _command,int _limit,Object _tag) throws Exception{
anywheresoftware.b4a.randomaccessfile.B4XSerializator _ser = null;
byte[] _data = null;
...
public wingan.app.main._dbresult  _handlejob(wingan.app.httpjob _job) throws Exception{
anywheresoftware.b4a.randomaccessfile.B4XSerializator _ser = null;
byte[] _data = null;
...
_res = (wingan.app.main._dbresult)(_ser.ConvertBytesToObject(_data));
...
public void  _handlejobasync(wingan.app.httpjob _job,String _eventname) throws Exception{
...
public ResumableSub_HandleJobAsync(wingan.app.dbrequestmanager parent,wingan.app.httpjob _job,String _eventname) {
this.parent = parent;
this._job = _job;
...
parent.__c.LogImpl("782182150","Error reading response: "+BA.ObjectToString(parent.__c.LastException(parent.getActivityBA())),0);
...
_res = (wingan.app.main._dbresult)(_newobject);
...
public String  _printtable(wingan.app.main._dbresult _table) throws Exception{
...
__c.LogImpl("782444289","Tag: "+BA.ObjectToString(_table.Tag /*Object*/ )+", Columns: "+BA.NumberToString(_table.Columns /*anywheresoftware.b4a.objects.collections.Map*/ .getSize())+", Rows: "+BA.NumberToString(_table.Rows /*anywheresoftware.b4a.objects.collections.List*/ .getSize()),0);
...
__c.LogImpl("782444295",_sb.ToString(),0);
...
__c.LogImpl("782444302",_sb.ToString(),0);
 }
};
 //BA.debugLineNum = 139;BA.debugLine="End Sub";
return "";
}
public wingan.app.httpjob  _sendjob(wingan.app.httpjob _j,byte[] _data,Object _tag,String _method) throws Exception{
