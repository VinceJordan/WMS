...
public class b4xdatetemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "wingan.app.b4xdatetemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", wingan.app.b4xdatetemplate.class).invoke(this, new Object[] {null});
        else
...
public wingan.app.b4xdialog _mdialog = null;
...
_mdialog = new wingan.app.b4xdialog();
...
public String  _show(wingan.app.b4xdialog _dialog) throws Exception{
...
if (BA.fastSubCompare(sub, "SHOW"))
	return _show((wingan.app.b4xdialog) args[0]);
